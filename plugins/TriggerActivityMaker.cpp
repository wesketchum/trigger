...
void
TriggerActivityMaker::init(const nlohmann::json& iniobj)
{
...
void
TriggerActivityMaker::do_start(const nlohmann::json& /*args*/)
{
  m_thread.start_working_thread();
}

void
TriggerActivityMaker::do_stop(const nlohmann::json& /*args*/)
{
  m_thread.stop_working_thread();
}

void
TriggerActivityMaker::do_configure(const nlohmann::json& config)
{
...
void
TriggerActivityMaker::do_work(std::atomic<bool>& running_flag)
{
  ...
  TLOG() << ": Exiting do_work() method, received " << received_count << " TPs and successfully sent " << sent_count
         << " TAs. ";
}
